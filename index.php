		...
		<body>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#topWrap">
							...
							E<span class="title"> - Stationery</span>
						</a>
					</div>
					<div class="collapse navbar-collapse appiNav">
						<ul class="nav navbar-nav">
							...
							<li><a href="#pricingWrap">Items</a></li>
			...
			<div class="container">
				<div class="col-md-6 col-md-push-6 jumboText">
					<h1>Online Stationeries Shop Platform</h1>
					<h2>By - University of Colombo Faculty of Management</h2>
					<a class="btn btn-lg btn-success actionBtn" href="#"><i class="fa fa-mobile fa-4x pull-left"></i><span class="line1">With Mobile</span><br/><span class="line2">Support</span></a>
				</div>
	...
	<div id="pricingWrap">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4">
					<ul class="priceTable">
						<li class="title">Stationeries</li>
				...
				<div class="col-sm-4">
					<ul class="priceTable">
						<li class="title">Activity items</li>
