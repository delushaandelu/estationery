						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">Stationery</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; By University of Colombo Faculty of Management</h4>
							</div>
											...
											<form method="POST" action="classlogin.php"  >
												<fieldset>
													...
													<div class="clearfix">
														...
														<button type="submit" name='log' class="width-35 pull-right btn btn-sm btn-primary">
