...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
<div class="container">
    <h2 class="list-group-item-heading">Pencil Boxes and Pencil Cases</h2>
    <a href="viewCart.php" class="cart-link" title="View Cart"><i class="glyphicon glyphicon-shopping-cart"></i></a>
    <div id="products" class="row list-group">
        <?php
		include 'dbConfig.php';
        //get rows query
        $query = $db->query("SELECT * FROM item where name='Pencil Boxes and Pencil Cases' ORDER BY id DESC LIMIT 10");
        if($query->num_rows > 0){ 
